...
@mcp.tool("Greeting")
async def run_greetings(name: str, ctx:Context) -> Greeting:
    """
    ...
    if authorization_header and authorization_header.startswith("Bearer "):
        try:
            ...
            # print("\nToken Claims before validation:", claims)
            claims.validate(
                # iss=OAUTH2_PROVIDER_URL, 
                # aud=AUDIENCE_URL, 
                # require_scopes=None
                )
        ...
        raise ValueError("Debug Authorization header missing or malformed")
